...
function e(n2, r2) {
  ...
  })(n2)) || r2 && n2 && "number" == typeof n2.length) {
    e2 && (n2 = e2);
    var i2 = 0;
    return function() {
...
function h(n2, t2) {
  if (!t2) return n2 && n2.then ? n2.then(s) : Promise.resolve();
}
var l = (function(t2) {
  function e2(n2, r2) {
    var e3, i2;
  ...
  return l2.register = function(n2) {
    ...
    return t3 && r(n2.prototype, t3), e3 && r(n2, e3), Object.defineProperty(n2, "prototype", { writable: false }), n2;
